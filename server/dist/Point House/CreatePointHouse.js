...
const CreatePointHouse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = req === null || req === void 0 ? void 0 : req.body;
        const result = yield Mining_Power_model_1.default.create([body]);
        return res.status(http_status_codes_1.OK).send((0, FormetResponseSend_1.default)(http_status_codes_1.OK, 'Point House Created!', result));
    }
    catch (error) {
...
exports.default = CreatePointHouse;
