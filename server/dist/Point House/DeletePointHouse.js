...
const DeletePointHouse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const query = req === null || req === void 0 ? void 0 : req.query;
        const result = yield Mining_Power_model_1.default.findByIdAndDelete(query === null || query === void 0 ? void 0 : query.id);
        return res.status(http_status_codes_1.OK).send((0, FormetResponseSend_1.default)(http_status_codes_1.OK, 'Point House Deleted!', result));
    }
    catch (error) {
...
exports.default = DeletePointHouse;
