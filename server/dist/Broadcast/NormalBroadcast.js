...
const NormalBroadcast = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield users.map((item) => {
            app_1.bot.telegram.sendPhoto(item === null || item === void 0 ? void 0 : item.TgId, img, {
                caption: text,
            });
        });
...
exports.default = NormalBroadcast;
