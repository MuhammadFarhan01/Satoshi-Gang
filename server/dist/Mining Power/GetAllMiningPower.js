...
const GetAllMiningPower = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield Mining_Power_model_1.default.find({});
        return res.status(http_status_codes_1.OK).send((0, FormetResponseSend_1.default)(http_status_codes_1.OK, 'All Mining Power!', result));
    }
    catch (error) {
...
exports.default = GetAllMiningPower;
