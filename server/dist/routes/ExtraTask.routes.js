...
ExtraTaskRoute.get("/story-checking-status", DecodeJWT_1.default, ExtraTask_controller_1.HasClaimedTodayStory);
ExtraTaskRoute.get("/ton-checking-status", DecodeJWT_1.default, ExtraTask_controller_1.HasUserTonTransectioned);
ExtraTaskRoute.get("/point-tracking", DecodeJWT_1.default, ExtraTask_controller_1.PointTracking);
ExtraTaskRoute.get("/airdrop", ExtraTask_controller_1.AllAirdrop);
ExtraTaskRoute.post("/story-checking", DecodeJWT_1.default, ExtraTask_controller_1.DailyStory);
